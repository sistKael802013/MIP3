            ...
            <div class="page-content">
                ...
                <div class="page-body">
                    <div class="btn-group" style="padding-bottom:10px;">
                        <button type="button" class="btn btn-labeled btn-blue" data-toggle="modal" data-target="#myModa"><i class="btn-label fa fa-plus"></i>Adicionar una Oportunidad</button>&nbsp;&nbsp;
                                  ...
                                  <div class="widget-body">
                                    ...
                                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                     <thead>
                                            <tr>
                                                <th>Codigo </th>
                                                <th class="hidden-xs"> Nombre Oportunidad</th>
                                        ...
                                        <?php 
                                            $sql4 = "SELECT * FROM crm_oport WHERE status = 'on'  ";
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <?php
                                                    $id_emp = $row1["id_emp"];
                                                    $variable ="SELECT * FROM  crm_empresas WHERE  id_emp = $id_emp";
                                                ...
                                                <td>
                                                    <div class="btn-group"> <a href="crm-vo.php?id=<?php echo $row1["id"];?>" type="button" class="btn btn-default"><i class="fa fa-edit"></i>Ver</a> </div>
                                                    <div class="btn-group"> <a href="pre-est.php?id=<?php echo $row1["id"];?>" type="button" class="btn btn-default"><i class="fa fa-edit"></i>Presupuestar</a> </div>
