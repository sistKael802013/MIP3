                ...
                <div class="widget">
                    ...
                    <div class="widget-body bordered-left bordered-blue">
                        ...
                        <!-- items de primer nivel -->
                            ...
                            ?>
                            <div class="panel-group accordion" id="#<?php echo $href_rand_aa; ?>">
                            <div class="panel panel-default">
                                <div class="panel-heading ">
                                    <h4 class="panel-title">
                                        <a class="accordion-toggle" data-toggle="collapse" data-parent="#<?php echo $href_rand_aa; ?>" href="#<?php echo $href_rand_a; ?>">
                                            <?php echo $row3["nombre"]; ?>
                                        </a>
                                    </h4>
                                </div>
                                <!-- items de segundo nivel en adelante -->
                                <div id="#<?php echo $href_rand_a; ?>" class="panel-collapse collapse in">
						            <div class="panel-body border-red">
						                <div class="buttons-preview">
						                    ...
						                    <!-- COMO SE ASIGNARÁ EL ID DEL ITEM AL BOTON APU? -->
						                    <a class="btn btn-default btn-xs" href="presup-apu.html">APU<i class="fa fa-plus right"></i></a>
						                </div>
										<?php 
										$id_esta = $row3["id_est"];
										$sql4 = "SELECT * FROM  pre_apu_est WHERE nivel = 2 AND id_oport = $id_oport AND id_madre = $id_esta";
										...
										?>
											...
											<?php } ?>
										<?php }else{ ?>
											<h2 style="text-align:center;">Sin items en este nivel.</h2> 
										<?php } ?>
									<?php } ?>
									<!-- items de segundo nivel en adelante --> 
									</div> 
