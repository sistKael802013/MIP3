                                                        ...
                                                        <div class="widget">
                                                            ...
                                                            <div class="widget-body bordered-left bordered-<?php echo $label?>">
                                                                <table class="table table-striped table-bordered table-hover">
                                                                    ...
                                                                    <tbody><?php $sql4 = "SELECT * FROM `flot-dserv` WHERE `id_dserv` = $id_dserv ";

                                                                                //$sql4 = "SELECT * FROM `flot-rep` WHERE `id_dserv` = $id_dserv";
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td class="hidden-xs">
                                                                                <?php echo $row2["cant_dserv"]; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?php echo $row2["vr_unit"]; 
                                                                                    
                                                                                ?>

                                                                            </td>
                                                                            <td>
                                                                                <a href="#"><?php echo $row2[""]; ?></a>
                                                                            </td>
                                                                            <td class="hidden-xs">
                                                                                <?php echo $row2["v_mo"]; ?>
                                                                            </td>
