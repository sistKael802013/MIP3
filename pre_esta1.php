                        ...
                        <!-- items de primer nivel -->
                            ...
                            if(!$resultset3){
                                ...
                                if ($resultset3->num_rows > 0){ 
                                    ...
                                    $href_rand_a = "collapse".rand(1, 9999);        
                                    $href_rand_aa = "accordion".rand(1, 9999);
                                    $id_st = $row3["id_est"]; 
	                          		...
	                          		<li class="dd-item bordered-inverse">
                                        <div class="dd-handle">
                                            ...
                                            <div class="btn-group" style="float:right;"> 
                                                <button type="button" data-toggle="modal" data-target='#mod_mob' class='btn btn-default btn-sm' style="border: none; outline:none;"><i class="fa fa-indent"></i></button>
                                                ...
                                                <button type="button" data-toggle="modal" data-target='#mod_mob' class='btn btn-default btn-sm' style="border: none; outline:none;"><i class="fa fa-close"></i></button>
                                            </div>
                                        </div>
                                    </li>
