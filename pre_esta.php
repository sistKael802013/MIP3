            ...
            <div class="well with-header  with-footer">
                ...
                <div class="widget">
                    ...
                    <div class="widget-body bordered-left bordered-blue">
                        ...
                        <br>
                        <br>
                        <div class="dd shadowed" style="max-width: 100%">
                            <ol class="dd-list dd-nodrag">
                            <?php 
                            $sql3 = "SELECT * FROM  pre_apu_est WHERE nivel = 1 AND id_oport = $id_oport AND id_madre = 0";
	                          		...
	                          		<li class="dd-item bordered-inverse">
                                        <div class="dd-handle">
                                            ...
                                            <div class="btn-group" style="float:right;"> 
                                                <button type="button" data-toggle="modal" data-target='#mod_lvl' onclick="lvl2(); $("#id_madre").val(<?php echo $row3["id_est"]; ?>);" class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-indent"></i></button>
                                                <button type="button" data-toggle="modal" data-target='#mod_mob' class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-plus"></i>APU</button>
                                                <button type="button" data-toggle="modal" data-target='#mod_mob' onclick="lvl2(); $("#id_madre").val(<?php echo $row3["id_est"]; ?>); $("#nom_item").val(<?php echo $row3["nombre"]; ?>);" class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-edit"></i></button>
                                                <button type="button" data-toggle="modal" data-target='#mod_eliminar' onclick="lvl2(); $("#id_item_el").val(<?php echo $row3["id_est"]; ?>);" class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-close"></i></button>
                                            </div>
                                        </div>
									<!-- SEGUNDO NIVEL ######################## -->
                                    <ol class="dd-list dd-nodrag" style="">
                                    <?php
                                    $sql4 = "SELECT * FROM pre_apu_est WHERE nivel = 2 AND id_oport = $id_oport AND id_madre = $id_st";
                                    ...
                                    ?>      
                                                <li class="dd-item" data-id="2">
                                                    <div class="dd-handle">
                                                        ...
                                                        <div class="btn-group" style="float:right;"> 
                                                            <button type="button" data-toggle="modal" data-target='#mod_lvl' onclick="lvl3(); $("#id_madre").val(<?php echo $row4["id_mad"]; ?>);" class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-indent"></i></button>
                                                            <button type="button" data-toggle="modal" data-target='#mod_mob' class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-plus"></i>APU</button>
                                                            <button type="button" data-toggle="modal" data-target='#mod_mob' onclick="lvl3(); $("#id_madre").val(<?php echo $row4["id_mad"]; ?>);" class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-edit"></i></button>
                                                            <button type="button" data-toggle="modal" data-target='#mod_eliminar' onclick="lvl3(); $("#id_madre").val(<?php echo $row4["id_mad"]; ?>);" class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-close"></i></button>
                                                        </div>
                                                    </div>
                                    				...
                                    				<ol class="dd-list dd-nodrag" style="">
                                    				<?php
				                                    $sql5 = "SELECT * FROM pre_apu_est WHERE nivel = 3 AND id_oport = $id_oport AND id_madre = $id_mad";
				                                    ...
				                                    ?>
						                                    <li class="dd-item" data-id="2">
			                                                    <div class="dd-handle">
			                                                        ...
			                                                        <div class="btn-group" style="float:right;"> 
			                                                            <button type="button" data-toggle="modal" data-target='#mod_mob' class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-plus"></i>APU</button>
			                                                            <button type="button" data-toggle="modal" data-target='#mod_mob' class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-edit"></i></button>
			                                                            <button type="button" data-toggle="modal" data-target='#mod_eliminar' class='btn btn-default btn-sm' style="border:none; outline:none;"><i class="fa fa-close"></i></button>
			                                                        </div>
			                                                    </div> 
			                                                </li>
			                                                <?php } ?>
				                                        ...
				                                        <ol class="dd-list" style="">
				                                            <li class="dd-item" data-id="2">
				                                                <div class="dd-handle">
				                                                    <h3 style="text-align:center;">No se encontraron items en este nivel.</h3>
				                                                </div>
				                                            </li>
				                                        </ol>
				                                        <?php } ?>
                                ...
                                <form action="pre_est.php?id=<?php echo $id_oport; ?>" method="post" role="form">
                                    <div id="registration-form">
                                        ...
                                        <div class="form-group">
                                        	<input type="hidden" id="lvl_item" name="no_nivel" value="0">
