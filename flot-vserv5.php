                                                            ...
                                                            <div class="widget-body bordered-left bordered-<?php echo $label?>">
                                                                <table class="table table-striped table-bordered table-hover">
                                                                    ...
                                                                    <tbody><?php $sql4 = "SELECT * FROM `flot-srep` WHERE `id_dserv` = $id_dserv";
                                                                                 $sql5 = "SELECT * FROM `flot-rep` ";
                                                                                $result4 = $conn->query($sql4);
                                                                                $result5 = $conn->query($sql5);

                                                                               if (($result4->num_rows > 0) && ($result5->num_rows > 0)) { 
                                                                                while(($row2 = $result4->fetch_assoc()) && ($row3 = $result5->fetch_assoc())) { ?>
                                                                        <tr>
                                                                            <td>
                                                                                <a href="#"><?php echo $row2["id_rep"]; ?>
                                                                                            <?php echo $row3["repuesto"]; ?>
                                                                                </a>
                                                                            </td>
                                                                            <td class="hidden-xs">
                                                                                <?php echo $row2["cant"]; ?>
                                                                            ...
                                                                            <td>
                                                                                <?php echo $row3["vr_unit"]; //echo $row2["especialidad"]; ?>
                                                                            </td>
                                                                            <td>
                                                                                <a href="#"><?php echo $tot_rep = $row2["cant"] * $row3["vr_unit"]//echo $row2["especialidad"]; ?></a>
                                                                            </td>
                                                                            <td class="hidden-xs">
                                                                                <?php echo $row2["v_mo"]; ?>
                                                                            </td>
                                                                            <td>
                                                                                <?php echo $subtotal = $row2["v_mo"] + $tot_rep//echo $row2["especialidad"]; ?>
                                                                            </td>
                                                                            <td>
